...
import { generateSessionTranscript } from '../scripts/utils.js';

test('generateSessionTranscript', async () => {
    ...
    const sessionTranscript = await generateSessionTranscript(origin, nonce, jwkThumbprint);
