 ...
 */
const createRequestParams = (options = {}) => {
    const {
 ...
 */
const getCredentials = async (requestParams, options = {}) => {
 ...
 */
const verifyCredentials = async (credentialResponse, options = {}) => {
    const {
        expectedProtocol,
        expectedTypes = [],
        verifierId,
...
export { DocumentType, SupportedClaim, createRequestParams, getCredentials, verify, verifyCredentials };
